...
class InterBlock(nn.Module):
    ...
    def forward(self,x):
        ...
        out_a = rearrange(out_a, 'b c (a1 h) (a2 w) -> b c (a1 a2) h w', a1=self.angRes, a2=self.angRes)
        out_s = rearrange(out_s, 'b c (a1 h) (a2 w) -> b c (a1 a2) h w', a1=self.angRes, a2=self.angRes)
        return out_a, out_s
