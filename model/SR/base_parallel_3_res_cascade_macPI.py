...
class AltFilter(nn.Module):
    def __init__(self, angRes):
        ...
        self.macPI_ang1 = nn.Conv2d(60, 25, kernel_size=5, dilation=1, padding =2, stride =5)
        self.to_SAI_f1 = nn.Conv3d(1, 60, kernel_size=(1, 3, 3), padding=(0, 1, 1), dilation=1)
        self.to_SAI_f2 = nn.Conv3d(1, 60, kernel_size=(1, 3, 3), padding=(0, 1, 1), dilation=1)
        self.macPI_ang2 = nn.Conv2d(60, 25, kernel_size=5*2, dilation=1, padding =3, stride =5)
    ...
    def forward(self, buffer):
        ...
        # buffer4 = rearrange(buffer, 'b c (a1 a2) h w -> b c (h a1) (w a2)', a1=self.angRes, a2=self.angRes)
        buffer4 = rearrange(buffer, 'b c (a1 a2) h w -> b c (h a1) (w a2)', a1=self.angRes, a2=self.angRes)

        buffer4 = self.macPI_ang1(buffer4).view(b,-1, a, h, w)
        buffer4 = self.to_SAI_f1(buffer4)
        buffer4 = rearrange(buffer4, 'b c (a1 a2) h w -> b c (h a1) (w a2)', a1=self.angRes, a2=self.angRes)

        buffer4 = self.macPI_ang2(buffer4).view(b,-1, a, h, w)
        buffer4 = self.to_SAI_f2(buffer4)
        # buffer4 = rearrange(buffer4, 'b c (h a1) (w a2) -> b c (a1 a2) h w', a1=self.angRes, a2=self.angRes)
