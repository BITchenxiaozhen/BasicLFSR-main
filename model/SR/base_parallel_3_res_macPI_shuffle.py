...
class InterBlock(nn.Module):
    ...
    def forward(self,x,x2):
        ...
        x2 = rearrange(x2, 'b c (a1 a2) h w -> b c (h a1) (w a2) ', a1=self.angRes, a2=self.angRes)

        xa = self.AngFE(x)
        xs = self.SpaFE(x2)
        buffer_spa1 = xs
        buffer_spa2 = self.Ang2Spa(xa)
        out_a = rearrange(buffer_spa1, 'b c (h a1) (w a2) -> b c (a1 a2) h w', a1=self.angRes, a2=self.angRes)
        out_s = rearrange(buffer_spa2, 'b c (h a1) (w a2) -> b c (a1 a2) h w', a1=self.angRes, a2=self.angRes)
        return out_a, out_s
