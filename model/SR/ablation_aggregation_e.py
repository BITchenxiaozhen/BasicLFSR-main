...
class body(nn.Module):
    ...
    def forward(self, buffer):
        ...
        buffer2 = self.AltFilter2(buffer1+buffer)
        buffer3 = self.AltFilter3(buffer2+buffer)
        buffer4 = self.AltFilter4(buffer3+buffer)
        buffer5 = self.AltFilter5(buffer4+buffer)
        buffer6 = self.AltFilter6(buffer5+buffer)
        buffer7 = self.AltFilter7(buffer6+buffer)
        buffer8 = self.AltFilter8(buffer7+buffer)+buffer
