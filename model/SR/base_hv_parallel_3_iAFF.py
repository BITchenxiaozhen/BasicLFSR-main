...
class AltFilter(nn.Module):
    def __init__(self, angRes):
        ...
        self.EPIFilter = AltFilter2(angRes=angRes, channels = 60)
...
class body(nn.Module):
    def __init__(self, angRes):
        ...
        self.AltFilter1 = AltFilter2(angRes=angRes)
        self.AltFilter2 = AltFilter2(angRes=angRes)
        self.AltFilter3 = AltFilter2(angRes=angRes)
        self.AltFilter4 = AltFilter2(angRes=angRes)
        self.AltFilter5 = AltFilter2(angRes=angRes)
        self.AltFilter6 = AltFilter2(angRes=angRes)
        self.AltFilter7 = AltFilter2(angRes=angRes)
        self.AltFilter8 = AltFilter2(angRes=angRes)
