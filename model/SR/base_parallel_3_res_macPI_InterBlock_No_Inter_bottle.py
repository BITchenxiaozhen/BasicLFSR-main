...
class AltFilter(nn.Module):
    def __init__(self, angRes):
        ...
        self.conv_de_1 = nn.Conv3d(60, 12, kernel_size=(1, 3, 3), padding=(0, 1, 1), dilation=1, bias=False)
        self.conv_de_2 = nn.Conv3d(60, 12, kernel_size=(1, 3, 3), padding=(0, 1, 1), dilation=1, bias=False)
        self.conv_de_3 = nn.Conv3d(60, 12, kernel_size=(1, 3, 3), padding=(0, 1, 1), dilation=1, bias=False)
        self.conv_de_4 = nn.Conv3d(60, 12, kernel_size=(1, 3, 3), padding=(0, 1, 1), dilation=1, bias=False)
        self.conv_de_5 = nn.Conv3d(60, 12, kernel_size=(1, 3, 3), padding=(0, 1, 1), dilation=1, bias=False)
    ...
    def forward(self, buffer):
        ...
        buffer1 = self.conv_de_1(self.ang_trans(buffer))
        buffer2 = self.conv_de_2(self.spa_trans(buffer))
        buffer3 = self.conv_de_3(self.EPIFilter(buffer))
