...
class body(nn.Module):
    def __init__(self, angRes):
        ...
        self.conv_1x1 = nn.Conv3d(60*7,60,1,1,0)
    ...
    def forward(self, buffer):
        ...
        buffer3 = buffer2 + buffer3
        buffer4 = buffer3 + buffer4
        buffer5 = buffer4 + buffer5
        buffer6 = buffer5 + buffer6
        buffer7 = buffer6 + buffer7
        buffer8 = buffer7 + buffer8
        buffer_concat = torch.cat([buffer2, buffer3, buffer4, buffer5, buffer6, buffer7, buffer8], 1)
        out = self.conv_1x1(buffer_concat)
        return out
